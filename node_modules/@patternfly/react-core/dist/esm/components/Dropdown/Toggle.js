...
export class Toggle extends React.Component {
  ...
  render() {
    ...
    return React.createElement(DropdownContext.Consumer, null, ({
      ...
      id: id,
      ref: this.buttonRef,
      className: css(isSplitButton ? styles.dropdownToggleButton : toggleClass || styles.dropdownToggle, isFocused && styles.modifiers.focus, isHovered && styles.modifiers.hover, isActive && styles.modifiers.active, isPlain && styles.modifiers.plain, isDisabled && styles.modifiers.disabled, className),
      type: type || 'button',
