  ...
  render() {
    const _this$props = this.props,
      ...
      keyHandler
          ...
          props = _objectWithoutProperties(_this$props, ["children", "className", "isExpanded", "openedOnEnter", "selected", "checked", "isGrouped", "sendRef", "keyHandler"]);

    return React.createElement(SelectConsumer, null, ({
      variant
    }) => React.createElement(React.Fragment, null, variant !== SelectVariant.checkbox && React.createElement("ul", _extends({}, props, {
      className: css(styles.selectMenu, className),
      role: "listbox"
    }), this.extendChildren()), variant === SelectVariant.checkbox && React.Children.count(children) > 0 && React.createElement(FocusTrap, {
      focusTrapOptions: {
    ...
    }, this.extendCheckboxChildren(props))))), variant === SelectVariant.checkbox && React.Children.count(children) === 0 && React.createElement("div", {
      className: css(styles.selectMenu, className)
    }, React.createElement("form", {
      noValidate: true,
      className: css(formStyles.form)
