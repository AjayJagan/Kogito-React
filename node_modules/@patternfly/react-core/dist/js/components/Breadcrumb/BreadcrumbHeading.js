...
var BreadcrumbHeading = function BreadcrumbHeading(_ref) {
  ...
  return React.createElement("li", _extends({}, props, {
    ...
    className: (0, _reactStyles.css)(_breadcrumb["default"].breadcrumbHeading)
  }, to && React.createElement(Component, {
    href: to,
    target: target,
    className: (0, _reactStyles.css)(_breadcrumb["default"].breadcrumbLink, _breadcrumb["default"].modifiers.current),
    "aria-current": "page"
