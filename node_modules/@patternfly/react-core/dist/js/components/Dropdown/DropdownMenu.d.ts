...
export declare class DropdownMenu extends React.Component<DropdownMenuProps> {
    refsCollection: React.RefObject<HTMLElement>[];
    static defaultProps: {
        className: string;
        isOpen: boolean;
        openedOnEnter: boolean;
    ...
    childKeyHandler: (index: number, position: string, custom?: boolean) => void;
    ...
    extendCustomChildren(): React.ReactElement<DropdownMenuItem, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>[];
    render(): JSX.Element;
}
