  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["position", "enableFlip", "children", "className", "aria-label", "headerContent", "bodyContent", "footerContent", "isVisible", "shouldClose", "appendTo", "hideOnOutsideClick", "onHide", "onHidden", "onShow", "onShown", "onMount", "zIndex", "maxWidth", "closeBtnAriaLabel", "distance", "boundary", "flipBehavior"]);

      if (!headerContent && !ariaLabel) {
        return new Error('aria-label is required when header is not used');
      }

      var content = React.createElement(_GenerateId["default"], null, function (randomId) {
        return React.createElement(FocusTrap, {
          active: _this2.state.isOpen,
          focusTrapOptions: {
      ...
      return React.createElement(_PopoverBase["default"], {
        arrow: true,
