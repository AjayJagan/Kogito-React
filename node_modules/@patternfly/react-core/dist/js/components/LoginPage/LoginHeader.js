...
var LoginHeader = function LoginHeader(_ref) {
  var _ref$className = _ref.className,
      ...
      _ref$headerBrand = _ref.headerBrand,
      headerBrand = _ref$headerBrand === void 0 ? null : _ref$headerBrand,
      props = _objectWithoutProperties(_ref, ["className", "children", "headerBrand"]);

  return React.createElement("header", _extends({
    className: (0, _reactStyles.css)(_login["default"].loginHeader, className)
