    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement(Component, _extends({
        ...
        return React.createElement("li", {
          key: index,
          className: (0, _reactStyles.css)(_tabs["default"].tabsItem, child.props.eventKey === activeKey && _tabs["default"].modifiers.current, className)
        }, React.createElement(_Tab.Tab, _extends({
          className: (0, _reactStyles.css)(_tabs["default"].tabsButton),
          onClick: function onClick(event) {
            return _this3.handleTabClick(event, child.props.eventKey, child.props.tabContentRef);
          },
          id: "pf-tab-".concat(child.props.eventKey, "-").concat(child.props.id || uniqueId),
          "aria-controls": child.props.tabContentId ? "".concat(child.props.tabContentId) : "pf-tab-section-".concat(child.props.eventKey, "-").concat(child.props.id || uniqueId)
        }, child.props), child.props.title));
      })), React.createElement("button", {
        className: (0, _reactStyles.css)(_tabs["default"].tabsScrollButton, isSecondary && _button["default"].modifiers.secondary),
        "aria-label": rightScrollAriaLabel,
        onClick: this.scrollRight
      }, React.createElement(_reactIcons.AngleRightIcon, null))), React.Children.map(children, function (child, index) {
        return !child.props.children ? null : React.createElement(_TabContent.TabContent, {
          key: index,
          activeKey: activeKey,
          child: child,
