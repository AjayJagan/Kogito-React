  ...
  _createClass(SelectMenu, [{
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          props = _objectWithoutProperties(_this$props4, ["children", "className", "isExpanded", "openedOnEnter", "selected", "checked", "isGrouped", "sendRef", "keyHandler"]);

      return React.createElement(_selectConstants.SelectConsumer, null, function (_ref) {
        var variant = _ref.variant;
        return React.createElement(React.Fragment, null, variant !== _selectConstants.SelectVariant.checkbox && React.createElement("ul", _extends({}, props, {
          className: (0, _reactStyles.css)(_select["default"].selectMenu, className),
          role: "listbox"
        }), _this2.extendChildren()), variant === _selectConstants.SelectVariant.checkbox && React.Children.count(children) > 0 && React.createElement(FocusTrap, {
          focusTrapOptions: {
        ...
        }, _this2.extendCheckboxChildren(props))))), variant === _selectConstants.SelectVariant.checkbox && React.Children.count(children) === 0 && React.createElement("div", {
          className: (0, _reactStyles.css)(_select["default"].selectMenu, className)
        }, React.createElement("form", {
          noValidate: true,
          className: (0, _reactStyles.css)(_form["default"].form)
