...
var AboutModalBoxBrand = function AboutModalBoxBrand(_ref) {
  ...
  return React.createElement("div", _extends({
    className: (0, _reactStyles.css)(_aboutModalBox["default"].aboutModalBoxBrand, className)
  }, props), React.createElement("img", {
    className: (0, _reactStyles.css)(_aboutModalBox["default"].aboutModalBoxBrandImage),
    src: src,
    alt: alt
  }));
};
