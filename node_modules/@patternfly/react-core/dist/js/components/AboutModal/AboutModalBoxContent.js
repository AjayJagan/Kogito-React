...
var _content = _interopRequireDefault(require("@patternfly/react-styles/css/components/Content/content"));
...
var AboutModalBoxContent = function AboutModalBoxContent(_ref) {
  var children = _ref.children,
      ...
      id = _ref.id,
      _ref$noAboutModalBoxC = _ref.noAboutModalBoxContentContainer,
      noAboutModalBoxContentContainer = _ref$noAboutModalBoxC === void 0 ? false : _ref$noAboutModalBoxC,
      props = _objectWithoutProperties(_ref, ["children", "className", "trademark", "id", "noAboutModalBoxContentContainer"]);

  return React.createElement("div", _extends({
    className: (0, _reactStyles.css)(_aboutModalBox["default"].aboutModalBoxContent, className),
    id: id
    ...
    className: (0, _reactStyles.css)(_content["default"].content)
  }, children)), React.createElement("p", {
    className: (0, _reactStyles.css)(_aboutModalBox["default"].aboutModalBoxStrapline)
  }, trademark));
};
