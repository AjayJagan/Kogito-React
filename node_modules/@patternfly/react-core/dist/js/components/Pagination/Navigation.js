...
function (_React$Component) {
  ...
  _createClass(Navigation, [{
    ...
    key: "onKeyDown",
    value: function onKeyDown(event, page, lastPage, onPageInput, onSetPage) {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          pagesTitle = _this$props.pagesTitle,
          toLastPage = _this$props.toLastPage,
          toNextPage = _this$props.toNextPage,
          toFirstPage = _this$props.toFirstPage,
          toPreviousPage = _this$props.toPreviousPage,
          currPage = _this$props.currPage,
          paginationTitle = _this$props.paginationTitle,
          onSetPage = _this$props.onSetPage,
          onNextClick = _this$props.onNextClick,
          onPreviousClick = _this$props.onPreviousClick,
          onFirstClick = _this$props.onFirstClick,
          onLastClick = _this$props.onLastClick,
          onPageInput = _this$props.onPageInput,
          className = _this$props.className,
          props = _objectWithoutProperties(_this$props, ["page", "isDisabled", "lastPage", "firstPage", "pagesTitle", "toLastPage", "toNextPage", "toFirstPage", "toPreviousPage", "currPage", "paginationTitle", "onSetPage", "onNextClick", "onPreviousClick", "onFirstClick", "onLastClick", "onPageInput", "className"]);
      ...
      return React.createElement("nav", _extends({
      ...
      }, React.createElement(_reactIcons.AngleLeftIcon, null)), React.createElement("div", {
        ...
        onKeyDown: function onKeyDown(event) {
          return _this2.onKeyDown(event, page, lastPage, onPageInput, onSetPage);
        },
        ...
        "aria-hidden": "true"
      }, "of ", (0, _helpers.pluralize)(lastPage, pagesTitle))), React.createElement(_Button.Button, {
        variant: _Button.ButtonVariant.plain,
      ...
      }, React.createElement(_reactIcons.AngleRightIcon, null)), React.createElement(_Button.Button, {
        variant: _Button.ButtonVariant.plain,
        isDisabled: isDisabled || page === lastPage,
