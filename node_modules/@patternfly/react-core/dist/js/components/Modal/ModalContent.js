...
var ModalContent = function ModalContent(_ref) {
  var children = _ref.children,
    ...
    return undefined;
      ...
      props = _objectWithoutProperties(_ref, ["children", "className", "isOpen", "header", "title", "hideTitle", "showClose", "footer", "actions", "onClose", "isLarge", "isSmall", "width", "ariaDescribedById", "id"]);
  ...
  var modalBoxFooter = footer ? React.createElement(_ModalBoxFooter.ModalBoxFooter, null, footer) : actions.length > 0 && React.createElement(_ModalBoxFooter.ModalBoxFooter, null, actions);
