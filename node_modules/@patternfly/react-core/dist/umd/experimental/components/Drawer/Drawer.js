(function (global, factory) {
  ...
  const Drawer = exports.Drawer = _ref => {
    let {
      className = '',
      children,
      isExpanded = false,
      ...
      panelContent
        ...
        props = _objectWithoutProperties(_ref, ["className", "children", "isExpanded", "isInline", "panelContent"]);

    return React.createElement("div", _extends({}, props, {
      className: (0, _reactStyles.css)(_drawer2.default.drawer, isExpanded && _drawer2.default.modifiers.expanded, isInline && _drawer2.default.modifiers.inline, className)
    }), React.createElement("div", {
      className: (0, _reactStyles.css)(_drawer2.default.drawerContent)
