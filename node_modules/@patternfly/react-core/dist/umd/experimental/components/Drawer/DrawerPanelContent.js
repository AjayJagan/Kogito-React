(function (global, factory) {
  ...
  const DrawerPanelContent = exports.DrawerPanelContent = _ref => {
    ...
    return React.createElement("aside", _extends({
      className: (0, _reactStyles.css)(_drawer2.default.drawerPanel, className)
    }, props), React.createElement("div", {
      className: (0, _reactStyles.css)(_drawer2.default.drawerPanelBody, noPadding && _drawer2.default.modifiers.noPadding)
    }, children));
  };
