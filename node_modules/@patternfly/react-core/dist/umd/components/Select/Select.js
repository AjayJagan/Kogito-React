  ...
  class Select extends React.Component {
    ...
    extendTypeaheadChildren(typeaheadActiveChild) {
      return this.state.typeaheadFilteredChildren.map(child => React.cloneElement(child, {
        isFocused: typeaheadActiveChild && typeaheadActiveChild.innerText === this.getDisplay(child.props.value.toString(), 'text')
      }));
    }
    ...
    render() {
      const _this$props = this.props,
        ...
        width
            ...
            props = _objectWithoutProperties(_this$props, ["children", "className", "variant", "onToggle", "onSelect", "onClear", "onFilter", "toggleId", "isExpanded", "isGrouped", "isPlain", "isDisabled", "selections", "ariaLabelledBy", "ariaLabelTypeAhead", "ariaLabelClear", "ariaLabelToggle", "ariaLabelRemove", "aria-label", "placeholderText", "width"]);
      ...
      return React.createElement("div", {
        className: (0, _reactStyles.css)(_select2.default.select, isExpanded && _select2.default.modifiers.expanded, className),
        ref: this.parentRef,
        style: {
          width
        }
        ...
        className: (0, _reactStyles.css)(_select2.default.selectToggleWrapper)
      }, selections && Array.isArray(selections) && selections.length > 0 && selectedChips, React.createElement("input", {
        className: (0, _reactStyles.css)(_formControl2.default.formControl, _select2.default.selectToggleTypeahead),
        "aria-activedescendant": typeaheadActiveChild && typeaheadActiveChild.id,
