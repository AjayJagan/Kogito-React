  ...
  const Card = exports.Card = _ref => {
    let {
      ...
      isCompact = false
        ...
        props = _objectWithoutProperties(_ref, ["children", "className", "component", "isHoverable", "isCompact"]);

    const Component = component;
    return React.createElement(Component, _extends({
      className: (0, _reactStyles.css)(_card2.default.card, isHoverable && _card2.default.modifiers.hoverable, isCompact && _card2.default.modifiers.compact, className)
    }, props), children);
  };
