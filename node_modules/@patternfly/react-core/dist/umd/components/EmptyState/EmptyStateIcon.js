(function (global, factory) {
  ...
  const EmptyStateIcon = exports.EmptyStateIcon = _ref => {
    ...
    return React.createElement(IconComponent, _extends({
      className: (0, _reactStyles.css)(_emptyState2.default.emptyStateIcon, className)
    }, props, {
      "aria-hidden": "true"
    }));
  };
  ...
  EmptyStateIcon.propTypes = {
    ...
    icon: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.any]).isRequired
  };
});
