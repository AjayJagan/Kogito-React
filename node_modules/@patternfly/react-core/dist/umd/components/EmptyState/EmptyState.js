(function (global, factory) {
  ...
  exports.EmptyState = exports.maxWidthModifiers = exports.EmptyStateVariant = undefined;
  ...
  let EmptyStateVariant = exports.EmptyStateVariant = undefined;
  ...
  ;
  let maxWidthModifiers = exports.maxWidthModifiers = undefined;

  (function (maxWidthModifiers) {
    maxWidthModifiers["large"] = "styles.modifiers.lg";
    maxWidthModifiers["small"] = "styles.modifiers.sm";
  })(maxWidthModifiers || (exports.maxWidthModifiers = maxWidthModifiers = {}));

  const EmptyState = exports.EmptyState = _ref => {
    let {
      children,
      className = '',
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_emptyState2.default.emptyState, maxWidthModifier, className)
    }, props), children);
  };
  ...
  EmptyState.propTypes = {
    ...
    variant: _propTypes2.default.oneOf(['small', 'large', 'full'])
  };
});
