(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "../Button"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("../Button"));
  } else {
    var mod = {
      exports: {}
    };
  ...
  exports.AlertActionLink = undefined;
  ...
  const AlertActionLink = exports.AlertActionLink = _ref => {
    let {
      className = '',
      children = ''
    } = _ref,
