(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "../../helpers/PopoverBase/PopoverBase", "@patternfly/react-styles/css/components/Tooltip/tooltip", "@patternfly/react-styles", "./TooltipContent", "../../helpers/constants", "@patternfly/react-tokens", "@patternfly/react-styles/css/components/Tooltip/tippy.css", "@patternfly/react-styles/css/components/Tooltip/tippy-overrides.css"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("../../helpers/PopoverBase/PopoverBase"), require("@patternfly/react-styles/css/components/Tooltip/tooltip"), require("@patternfly/react-styles"), require("./TooltipContent"), require("../../helpers/constants"), require("@patternfly/react-tokens"), require("@patternfly/react-styles/css/components/Tooltip/tippy.css"), require("@patternfly/react-styles/css/components/Tooltip/tippy-overrides.css"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.PopoverBase, global.tooltip, global.reactStyles, global.TooltipContent, global.constants, global.reactTokens, global.tippy, global.tippyOverrides);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _PopoverBase, _tooltip, _reactStyles, _TooltipContent, _constants, _reactTokens) {
  "use strict";
    ...
    render() {
      const _this$props = this.props,
        ...
        flipBehavior
            ...
            rest = _objectWithoutProperties(_this$props, ["position", "trigger", "enableFlip", "children", "className", "content", "entryDelay", "exitDelay", "appendTo", "zIndex", "maxWidth", "isAppLauncher", "distance", "aria", "boundary", "flipBehavior"]);
      ...
      const content = React.createElement("div", _extends({
        ...
        role: "tooltip"
      }, rest), React.createElement(_TooltipContent.TooltipContent, null, bodyContent));
      return React.createElement(_PopoverBase2.default, {
        arrow: true,
        aria: aria,
