(function (global, factory) {
  ...
  exports.DataListItemRow = undefined;
  ...
  const DataListItemRow = exports.DataListItemRow = _ref => {
    let {
      children,
      className = '',
      rowid = ''
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_dataList2.default.dataListItemRow, className)
