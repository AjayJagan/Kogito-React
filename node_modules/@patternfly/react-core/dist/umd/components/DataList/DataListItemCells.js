(function (global, factory) {
  ...
  exports.DataListItemCells = undefined;
  ...
  const DataListItemCells = exports.DataListItemCells = _ref => {
    let {
      className = '',
      dataListCells,
      rowid = ''
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_dataList2.default.dataListItemContent, className)
    }, props), dataListCells);
  };

  DataListItemCells.propTypes = {
    className: _propTypes2.default.string,
    dataListCells: _propTypes2.default.node,
